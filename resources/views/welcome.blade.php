...
<body class="font-sans antialiased dark:bg-black dark:text-white/50 h-screen overflow-hidden">
    @csrf
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <svg class="h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]" fill="#ffffff" version="1.1"
                            id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="800px" height="800px" viewBox="0 0 31.445 31.445" xml:space="preserve">
                            <g>
                                <g>
			...
			c0.531,0,0.967,0.434,0.967,0.967S24.596,21.032,24.064,21.032z" />
                ...
                <main class="mt-3">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="https://en.wikipedia.org/wiki/Supercar" id="docs-card"
                            ...
                            <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                <img src="https://laravel.com/assets/img/welcome/docs-light.svg"
                                    ...
                                    onerror="
                                        ...
                                        " />
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Supercar_Lineup_%2818092106572%29.jpg/1200px-Supercar_Lineup_%2818092106572%29.jpg"
                                    alt="Laravel documentation screenshot"
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img"
                                        data-id="8074800" data-premium="">
                                    </div>
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Find Your Super Car
                                        </h2>
                                        <p class="mt-4 text-sm/relaxed">
                                            This is where you can find your super model cars.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a href="https://www.youtube.com/playlist?list=PLxuVK1A8anZsSZWHq-rA2T-XTDBKJnsWN"
                            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img"
                                data-id="187210" data-premium="">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Wikipedia-logo-v2.svg/1200px-Wikipedia-logo-v2.svg.png"
                                    width="180" height="180" alt="" title="" class="img-small">
                            </div>


                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Read about super cars.
                                </h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Read the documents about super cars from wikipedia.
                                    Learn everything about cars, their speed, comfort levels etc...
                                </p>
                            </div>
                        ...
                        <a href="https://www.refined-marques.com/7-factors-to-consider-when-choosing-a-supercar-2/"
                            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img"
                                data-id="2303934" data-premium="">
                                <img src="https://www.refined-marques.com/wp-content/uploads/2022/09/car-ford-gt-900x480-2.jpg"
                                    width="200" height="200" alt="" title="" class="img-small">
                            </div>
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Our advices for super cars
                                </h2>
                                <p class="mt-4 text-sm/relaxed">
                                    What should you be aware of when you buy super model cars.
                            </div>
                            <svg class="size-6 shrink-0 self-center stroke-[#FF2D20]" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a
                            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            <div class="main-icon-without-slide icon-png-container pd-lv4" data-type="img"
                                data-id="733553" data-premium="">
                                <img src="https://pyxis.nymag.com/v1/imgs/e17/12e/2b43ea62b5759839f7fed58941603569ef-9-koenigsegg-regera.h473.w710.jpg"
                                    width="128" height="128" alt="" title="" class="img-small">
                            </div>
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Are you ready?</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Register right know and find your car.
                            </div>
                        </a>
                    </div>
                </main>
